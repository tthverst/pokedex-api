...
function fillTestPokemon(Pokemon, done) {
	var testData = [
		...
		{ id: 2, name: 'Charmander', height: 6, weight: 85, types: ["fire"], stats: { "hp": 39, "attack": 52, "defence": 43, "sp-atk": 60, "sp-def": 50, "speed": 65 }, capture_rate: 45, flavour_text: "Lorem ipsum" },
